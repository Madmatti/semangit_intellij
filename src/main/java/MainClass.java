...
public class MainClass implements Runnable {
     ...
     * @return false, if line seems intact, true otherwise.
     */
    private static boolean corruptedInputCheck(TableSchema schema, String[] line)
    {
        //TODO: Yes, this does verify the integrity of every single line in itself. But in case of a schema update, this won't suffice
    ...
    private static void parseCommitParents(String path) throws Exception {
        try {
            ...
            while ((nextLine = reader.readNext()) != null) {
                if(corruptedInputCheck(schema, nextLine))
                {
                    continue;
                }
    ...
    private static void parseCommits(String path) throws Exception {
        try {
    ...
    private static void parseFollowers(String path) throws Exception
    {
        try {
    ...
    private static void parseIssueEvents(String path) throws Exception {
        try {
    ...
    private static void parseIssueLabels(String path) throws Exception {
        try {
    ...
    private static void parseIssues(String path) throws Exception {
        try {
    ...
    private static void parseOrganizationMembers(String path) throws Exception
    {
        try {
    ...
    private static void parseProjectCommits(String path) throws Exception
    {
        try {
    ...
    private static void parseProjectMembers(String path) throws Exception
    {
        try {
    ...
    private static void parseProjects(String path) throws Exception
    {
        try {
    ...
    private static void parsePullRequestCommits(String path) throws Exception
    {
        try
        {
    ...
    private static void parsePullRequestHistory(String path) throws Exception {
        try {
    ...
    private static void parsePullRequests(String path) throws Exception {
        try {
    ...
    private static void parseRepoLabels(String path) throws Exception
    {
        try
        {
    ...
    private static void parseRepoMilestones(String path) throws Exception
    {
        try
        {
    ...
    private static void parseUsers(String path) throws Exception
    {
        try
        {
    ...
    private static void parseWatchers(String path) throws Exception
    {
        try {
    ...
    private static void parseProjectLanguages(String path) throws Exception
    {
        try {
    ...
    private static void parseCommitComments(String path) throws Exception {
        try {
    ...
    private static void parseIssueComments(String path) throws Exception {
        try {
    ...
    private static void parsePullRequestComments(String path) throws Exception {
        try {
        ...
        try {
            switch (workOnFile) {
                case "commit_comments":
                    parseCommitComments(this.path);
                    break;
                case "commit_parents":
                    parseCommitParents(this.path);
                    break;
                case "commits":
                    parseCommits(this.path);
                    break;
                case "followers":
                    parseFollowers(this.path);
                    break;
                case "issue_comments":
                    parseIssueComments(this.path);
                    break;
                case "issue_events":
                    parseIssueEvents(this.path);
                    break;
                case "issue_labels":
                    parseIssueLabels(this.path);
                    break;
                case "issues":
                    parseIssues(this.path);
                    break;
                case "organization_members":
                    parseOrganizationMembers(this.path);
                    break;
                case "project_commits":
                    parseProjectCommits(this.path);
                    break;
                case "project_languages":
                    parseProjectLanguages(this.path);
                    break;
                case "project_members":
                    parseProjectMembers(this.path);
                    break;
                case "projects":
                    parseProjects(this.path);
                    break;
                case "pull_request_comments":
                    parsePullRequestComments(this.path);
                    break;
                case "pull_request_commits":
                    parsePullRequestCommits(this.path);
                    break;
                case "pull_request_history":
                    parsePullRequestHistory(this.path);
                    break;
                case "pull_requests":
                    parsePullRequests(this.path);
                    break;
                case "users":
                    parseUsers(this.path);
                    break;
                case "repo_labels":
                    parseRepoLabels(this.path);
                    break;
                case "repo_milestones":
                    parseRepoMilestones(this.path);
                    break;
                case "watchers":
                    parseWatchers(this.path);
                    break;
                default:
                    throw new RuntimeException("Unknown file name specified! Which file to parse?!");
            }
        }
        catch (Exception e)
        {
